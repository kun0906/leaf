...
from keras.applications import VGG16, VGG19, NASNetLarge, ResNet50, DenseNet201, InceptionV3
...
from data.femnist.mycnn import MYCNN
...
def main():
	...
	ROOT_DIR = '.'
	model_file = os.path.join(ROOT_DIR, f'vgg16_{DATASET_NAME}.h5')
